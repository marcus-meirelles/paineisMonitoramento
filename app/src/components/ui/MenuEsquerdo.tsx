    ...
    return (
      <>
        ...
        <NavLink href="#" label="Usuários" leftSection={<IconUser size={16} stroke={1.5} />} childrenOffset={10}>
          ...
          <NavLink href="/usuario/cadastrar" label="Cadastrar" leftSection={<IconUserPlus size={16} stroke={1.5} />} childrenOffset={10}/>
        </NavLink>
        <NavLink href="#" label="Painéis" leftSection={<IconChartBar size={16} stroke={1.5} />} childrenOffset={10}>
          ...
          <NavLink href="/painel/cadastrar" label="Cadastrar" leftSection={<IconBrowserPlus size={16} stroke={1.5} />} childrenOffset={10}/>
        </NavLink>
      </>
    );
  }
